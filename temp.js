(function() {
  ...
  window.app = {
    ...
    setCanvas: function() {
      ...
      document.getElementById('container').appendChild(this.screen_1.canvas);

      if ( this.shouldWrap ) {

        this.screen_2 = this.createCanvasAndContext();
        document.getElementById('container').appendChild(this.screen_2.canvas);
        this.screen_3 = this.createCanvasAndContext();
        document.getElementById('container').appendChild(this.screen_3.canvas);
    ...
    splitData: function( data ) {
      ...
      for( var index = 0; index < rows.length; index++ ) {
        ...
        this.createRow(screen, rows[index], this.config.font_height += this.config.row_height, index);
      }
    ...
    createRow: function( screen, data, yPos, index ) {
      var name  = null;
    ...
    drawAndUpdate: function() {
      var _this   = window.app,
        ...
        requestAnimationFrame(_this.drawAndUpdate);
  ...
  var Name = function(screen, name, age, speed, xPos, yPos, index) {
